...
- Write your user stories as described above and place them in a file called user-stories.md*. Utilize good Markdown style to make this look nice.
...
All of that is an adequate amount of progress to have completed by class time on Tuesday.
